...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4 bg-background text-text-main relative overflow-hidden">
      ...
      <div className="absolute bottom-[-20%] right-[-10%] w-[40%] h-[40%] bg-primary/10 blur-[100px] rounded-full pointer-events-none" />
          ...
          <div className="relative z-10 space-y-6">
            <div className="p-4 rounded-xl bg-surface-1 border border-border/50 backdrop-blur-sm">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="font-semibold text-white">Intelligent Mapping</span>
              </div>
            ...
            <div className="p-4 rounded-xl bg-surface-1 border border-border/50 backdrop-blur-sm">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="font-semibold text-white">Accelerated Growth</span>
              </div>
              <p className="text-sm text-text-muted">
